"""Build Entry 003 Page 4 as a transparent production artwork layer.

This mirrors the approved Page 1 through Page 3 production extraction:
preserve the generated RGB source, remove its near-white field, reconstruct
neutral black/red ink, fit it inside the same safe area, and emit the exact
...
SOURCE = ENTRY / "source" / "page-04-imagegen-rgb.png"
OUTPUT = ENTRY / "artwork" / "page-04.png"
REPORT = ENTRY / "source" / "page-04-processing.json"
...
def main() -> None:
    ...
    bbox = alpha.getbbox()
    if bbox is None:
        raise RuntimeError("Entry 003 Page 4 extraction produced no artwork")
