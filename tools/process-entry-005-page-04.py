"""Build Entry 005 Page 4 as a transparent production artwork layer.
...
def extract_ink(source: Image.Image) -> Image.Image:
    ...
    # Mirror the approved Entry 005 Pages 1-3 extraction exactly: separate
...
def main() -> None:
    ...
    bbox = alpha.getbbox()
    if bbox is None:
        raise RuntimeError("Entry 005 Page 4 extraction produced no artwork")
