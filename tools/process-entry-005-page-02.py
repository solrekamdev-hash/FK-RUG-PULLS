"""Build Entry 005 Page 2 as a transparent production artwork layer.
...
def extract_ink(source: Image.Image) -> Image.Image:
    ...
    # Mirror the approved Entry 005 Page 1 extraction exactly: separate
...
def main() -> None:
    ...
    bbox = alpha.getbbox()
    if bbox is None:
        raise RuntimeError("Entry 005 Page 2 extraction produced no artwork")
