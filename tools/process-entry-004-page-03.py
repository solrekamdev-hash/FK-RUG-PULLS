"""Build Entry 004 Page 3 as a transparent production artwork layer.
...
def extract_ink(source: Image.Image) -> Image.Image:
    ...
    # Mirror the approved Entry 004 Pages 1-2 extraction exactly: separate
...
def main() -> None:
    ...
    bbox = alpha.getbbox()
    if bbox is None:
        raise RuntimeError("Entry 004 Page 3 extraction produced no artwork")
