"""Build Entry 003 Page 3 as a transparent production artwork layer.

This mirrors the approved Page 1 and Page 2 production extraction: preserve
the generated RGB source, remove its near-white field, reconstruct neutral
...
SOURCE = ENTRY / "source" / "page-03-imagegen-rgb.png"
OUTPUT = ENTRY / "artwork" / "page-03.png"
REPORT = ENTRY / "source" / "page-03-processing.json"
...
def main() -> None:
    ...
    bbox = alpha.getbbox()
    if bbox is None:
        raise RuntimeError("Entry 003 Page 3 extraction produced no artwork")
