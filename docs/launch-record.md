...
- [ ] Reconfirm the project name `FK RUG PULLS` and ticker `FRP`.
- [ ] Reconfirm blockchain: Solana.
- [ ] Reconfirm platform: Pump.fun.
- [ ] Reconfirm pair: SOL.
- [ ] Reconfirm Cash Back: ON.
...
- Creation date and time (UTC): Not deployed
- Official mint address: Not deployed
